...
def train_model(data_helper):
    ...
    rst_parser.save(model_dir='..\data\model\\rn~model-nuc')
...
if __name__ == '__main__':
    ...
    if args.log:
        data_helper.print_action_map('../data/data_helper_average.bin')
    ...
    if args.eval:
        ...
        evaluator = Evaluator(model_dir='../data/model/rn~model-nuc')
