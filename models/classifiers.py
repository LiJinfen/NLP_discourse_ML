...
class RelationClassifier(object):
    def __init__(self,
        ...
        self.classifier_level_0 = LinearSVC(C=1.0, penalty='l1', loss='squared_hinge', dual=False, tol=1e-7, max_iter=42000)
        self.classifier_level_1 = LinearSVC(C=1.0, penalty='l1', loss='squared_hinge', dual=False, tol=1e-7, max_iter=42000)
        self.classifier_level_2 = LinearSVC(C=1.0, penalty='l1', loss='squared_hinge', dual=False, tol=1e-7, max_iter=42000)
